...
class Ui_PlayWindow(object):
    def setupUi(self, PlayWindow):
        ...
        PlayWindow.setTabOrder(self.homeButton, self.pauseButton)
        PlayWindow.setTabOrder(self.pauseButton, self.repeatButton)
    ...
    def retranslateUi(self, PlayWindow):
        ...
        self.pauseButton.setText(_translate("PlayWindow", "&Pause Game", None))
